...
const replies: [RegExp, string][] = [
  ...
  [/ropa|wear|merch|streetwear|camiseta|polera|gorra|buso|sudadera|talla|vestimenta|moda/i,
    "Por ahora NENEZ esta enfocado en eventos y accesos. Si necesitas soporte, por favor escribe al correo de soporte oficial: soporte.nenez@gmail.com."],
  ...
  [/contacto|soporte|ayuda|asesor|whatsapp.*ayuda|problema|error/i,
    "Si tienes algún problema con tu compra o entrada, por favor escribe directamente al correo de soporte de NENEZ: soporte.nenez@gmail.com para ayudarte de inmediato."],

  // Cedula / documento
  [/c[eé]dula|documento|identidad|id|identificacion|ruc|pasaporte/i,
    "El sistema valida la cedula ecuatoriana con el algoritmo de modulo 10. Deben ser 10 digitos sin letras. Si eres extranjero, por favor escribe directamente al correo de soporte de NENEZ: soporte.nenez@gmail.com."],
  ...
  [/pago.*fallo|fallo.*pago|reembolso|devolver|cancelar|reclamo/i,
    "Si tu pago falló o necesitas ayuda con un reembolso, por favor escribe directamente al correo de soporte de NENEZ: soporte.nenez@gmail.com con tu comprobante y código de transacción."],
  [/extranjero|turista|visitante|fuera.*ecuador|otro.*pa[ií]s/i,
    "Si eres extranjero, el sistema requiere cedula ecuatoriana. Si no tienes, por favor escribe directamente al correo de soporte de NENEZ: soporte.nenez@gmail.com para el registro manual."],
