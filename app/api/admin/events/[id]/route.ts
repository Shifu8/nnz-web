  ...
  try {
    ...
    if (!existing && lookupSlug) {
      ...
      if (fe) {
        ...
        const fullEvent = {
          ...
          time,
          countdownDate: "",
          onlineSalesCutoffTime: body.onlineSalesCutoffTime || fe.onlineSalesCutoffTime || "14:00",
          price: 10,
          imageUrl: fe.poster || "",
    ...
    if (existing) {
      ...
      const updateFields: any = {
        ...
        onlineSalesCutoffTime: body.onlineSalesCutoffTime ?? existing.onlineSalesCutoffTime,
