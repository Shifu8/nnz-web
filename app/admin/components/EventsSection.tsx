  ...
  return (
    <div className="px-6 py-8 space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-[9px] font-black uppercase tracking-[0.3em] text-zinc-500">Gestion</p>
          <p className="text-xl font-black text-white mt-1">Eventos</p>
        </div>
      </div>

      {/* ADD EVENT BUTTON */}
      <div style={{background: "#ffff00", color: "#000000", padding: "10px", marginBottom: "4px", borderRadius: "8px", fontSize: "14px", fontWeight: "bold", textAlign: "center"}}>
        -- ZONA DE BOTON --
      </div>
      <div onClick={() => { alert("click!"); openCreate(); }} style={{
        background: "#ff0000", color: "#ffffff", padding: "20px", fontSize: "16px",
        fontWeight: "bold", textAlign: "center", border: "3px solid #ffffff",
      ...
      {events.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 rounded-3xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-xl">
          ...
          <p className="text-sm font-bold text-zinc-600">No hay eventos</p>
          <p className="text-[9px] text-zinc-700 mt-1">Crea tu primer evento para empezar.</p>
        </div>
      ) : (
          ...
          {sorted.map((event, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-3xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-xl transition-all duration-500 hover:border-white/20 hover:shadow-[0_0_40px_rgba(255,0,24,0.06)]"
              >
                {/* Image */}
        ...
        {showModal && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-2xl rounded-[32px] border border-white/[0.08] bg-zinc-950/90 backdrop-blur-2xl p-8 shadow-[0_0_80px_rgba(0,0,0,0.9)]"
