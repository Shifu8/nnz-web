...
export const THEMES: ThemePreset[] = [
  ...
  },
  {
    ...
    colors: {
      ...
      bgFrom: "#6d5dfc",
      bgTo: "#1e1b4b",
      glowRgba: "rgba(109,93,252,0.5)",
      glowIntense: "rgba(109,93,252,0.8)",
      borderRgba: "rgba(109,93,252,0.3)",
      btnFrom: "#6d5dfc",
      btnTo: "#4438ca",
      btnShadow: "rgba(155,140,255,0.4)",
      textAccent: "#faf5ff",
      badgeBg: "#6d5dfc",
      cardBorder: "rgba(109,93,252,0.16)",
      cardShadow: "rgba(109,93,252,0.12)",
      hoverGlow: "rgba(155,140,255,0.4)",
      tagBg: "rgba(109,93,252,0.15)",
    },
  },
  {
    id: "green",
