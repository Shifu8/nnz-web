 ...
 * Fecha: 11/05/2026
 * Descripción: Configuración del cliente de Firebase para la aplicación NENEZ.
 */
...
const firebaseConfig = {
  ...
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || "nenez-underground-mock",
