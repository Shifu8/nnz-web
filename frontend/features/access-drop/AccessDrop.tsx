          ...
          {dropState === "register" && (
            <div className="relative z-10 w-full mx-auto">
              ...
              <div className="mb-5 select-none">
                ...
                <div className="mt-2.5 p-2.5 rounded-xl bg-zinc-950 border border-white/10 flex items-center justify-center text-center text-zinc-300 select-none">
          ...
          {dropState === "success" && (
            <div ref={successRef} className="success-reveal relative z-10 flex flex-col items-center text-center max-w-md mx-auto py-12">
              ...
              {formData.firstName.trim() && (
                <h2 className="success-name text-[20px] font-black text-white uppercase tracking-[0.22em] drop-shadow-[0_0_12px_rgba(255,255,255,0.12)]">
              ...
              <p className="success-msg mt-5 text-[11.5px] font-medium text-zinc-400 leading-relaxed max-w-xs mx-auto">
