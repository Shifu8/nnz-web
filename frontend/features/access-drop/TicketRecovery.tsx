...
export default function TicketRecovery({ embedded = false, className = "", pulse = false }: TicketRecoveryProps) {
  ...
  return (
    ...
    >
      <div
        className={`relative grid gap-10 overflow-hidden rounded-[32px] border border-white/10 bg-black/45 p-5 backdrop-blur-2xl sm:p-7 lg:p-9 shadow-2xl grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center ${
      ...
      >
        ...
        {/* Left Column: Symmetrical info content */}
        ...
        {/* Right Column: Process cards at the top, interactive form card below */}
        <div className="relative z-10 flex flex-col gap-6 w-full">
          
          {/* Recovery Process Cards - Identical styling, dimensions, fonts, and animation as Access section */}
          ...
          <div className="relative rounded-[24px] border border-white/10 bg-black/60 p-6 sm:p-8 backdrop-blur-2xl shadow-xl">
            {phase === "email" && (
